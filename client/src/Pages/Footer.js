                            ...
                            <form method="post" action="https://jufailitech.com/envatoitems/travilo/html/contact.html">
                                <div className="form-group">
                                    <div className="field-inner">
                                        <input type="email" name="email" onChange={(e)=>handleChange(e)}  placeholder="Type your email here"
                                            required />
                                    </div>
                                        ...
                                        <div className="footer-info">
                                            <ul className="info">
                                                <li className="address"><a href="#"><i className="icon fa fa-map-marker-alt"></i>
                                                    20, Desai Street, Sagrampura, Surat</a></li>
