        ...
        <div className="py-2">
          <div className="row py-2">
            <div className="col-md-6">
              ...
              <input type="text" className="bg-light form-control" placeholder="Steve"/>
            </div>
            <div className="col-md-6 pt-md-0 pt-3">
              <label for="lastname">Last Name</label>
              <input type="text" className="bg-light form-control" placeholder="Smith"/>
            </div>
          </div>
          <div className="row py-2">
            <div className="col-md-6">
              <label for="email">Email Address</label>
              <input type="text" className="bg-light form-control" placeholder="steve_@email.com"/>
            </div>
            <div className="col-md-6 pt-md-0 pt-3">
              <label for="phone">Phone Number</label>
              <input type="tel" className="bg-light form-control" placeholder="+1 213-548-6015"/>
            </div>
          </div>
          <div className="row py-2">
            <div className="col-md-6">
